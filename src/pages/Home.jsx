...
const Home = () => {
  return (
    <main className="relative isolate bg-[#F8F8F8] dark:bg-[#1F2937] overflow-hidden">
      ...
      <motion.section
        className="relative isolate min-h-screen flex items-center justify-center bg-[#F8F8F8] dark:bg-[#1F2937] px-4 sm:px-8 lg:px-16"
      ...
      >
        ...
        <div className="w-full max-w-4xl overflow-hidden">
          <h1 className="mt-5 mb-5 text-center text-3xl sm:text-6xl md:text-4xl font-bold text-[#1E3A8A] dark:text-[#FAFAFA] font-poppins">
